...
class TransferFunctionHeader(object):
    ...
    #         print(
    #             "did not find exactly 2 horizontal magnetic channels for local site"
    #         )
    #         # ?raise Exception?
    #
    #     if SITES.VTF:
    ...
    #         elif length(HZind) > 1:
    #             print("more than 1 vertical magnetic channel found for local site")
    #             # ?raise Exception?
    #         else:
    ...
    #             print(
    #                 "did not find exactly 2 horizontal magnetic channels "
    #                 "for reference site"
    #             )
    #             # ?raise Exception?
    #     else:
