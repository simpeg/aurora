...
class TestScrapeSPUD(WidesScaleTest):
	...
	def enrich_row(self, row):
		...
		download_emtf = to_download_or_not_to_download(emtf_filepath, self.force_download_emtf, emtf_or_data="EMTF")
		if download_emtf:
			try:
		...
		download_data = to_download_or_not_to_download(data_filepath, self.force_download_data, emtf_or_data="DATA")
		if download_data:
			try:
